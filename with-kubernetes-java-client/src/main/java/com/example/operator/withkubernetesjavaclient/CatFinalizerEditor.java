...
public class CatFinalizerEditor {
	...
	public V1alpha1CatForAdoption add(V1alpha1CatForAdoption cat) throws ApiException {
	...
	public V1alpha1CatForAdoption remove(V1alpha1CatForAdoption cat) throws ApiException {
		return PatchUtils.patch(
				V1alpha1CatForAdoption.class,
				() -> api.patchNamespacedCatForAdoptionCall(
						cat.getMetadata().getName(),
